...
$\gg$ clipping ; (3) le seuil critique d'hallucination est identifié à
25 mots. Nous proposons un détecteur d'hallucinations réutilisable en
...
hallucinations, multilingue, évaluation systématique.
\end{abstract}
...
\begin{enumerate}
    ...
    \item Fine-tuning ciblé sur les cas difficiles (FR + reverb).
